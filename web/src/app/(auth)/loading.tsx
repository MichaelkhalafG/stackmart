...
/**
 * Group-level loading for the (auth) routes — mirrors the `AuthShell` split card (form side +
 * branded navy panel) at a neutral two-field size, so any auth route it covers doesn't jump.
 * Container comes from the (auth) layout.
 */
